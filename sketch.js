...
let maxSegmentSize = 200; // Maximum size of each segment
...
function draw() {
  ...
  if (buffer.length >= delayFrames) {
    ...
    for (let i = 0; i < numSegments; i++) {
      ...
      let z = random(700, 40000); // Assign a random depth in the z-axis (from 0 to 1)
      ...
      let perspectiveFactor = map(z, 1, 4000, 1, 0); // Adjust perspective based on depth
